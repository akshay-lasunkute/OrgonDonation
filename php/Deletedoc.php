...
<body>
    <header>
        ...
        <section id="sidenavbar">
            <button>Dashboard</button>
                ...
                <div>
                    ...
                    <a id="current" href="Deletedoc.php">update/delete doctor</a>
                </div>
        ...
        <section class="container-fluid bg">
            ...
            <section id="staffpart">
                <h4 style="text-align: center;color: orangered;margin-top: 2%;background-color: lightpink;width: 100%;">Update Doctor Information</h4>
    ...
    ?>
        ...
        <section id="updatesection" style="margin-left:35%">
             <form method="post" action="updoc.php" style="margin-top: 2%;width: 55%;" >
                
                <br><label>Enter the Doctor ID :</label><input name="docid" type="number"required style="float: right;"><br>
                ...
                <br><input type="submit" value="Update the Doctor" style="margin-left: 30%;">
